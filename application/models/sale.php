...
class Sale extends CI_Model
{
	...
	public function create_sales_items_temp_table()
	{
		...
		".$this->db->dbprefix('items').".item_id,".$this->db->dbprefix('items').".stock_type as sale_type, supplier_id, quantity_purchased, item_cost_price, item_unit_price, SUM(percent) as item_tax_percent,
